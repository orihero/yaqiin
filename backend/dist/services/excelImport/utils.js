...
exports.generateFallbackUzbekName = generateFallbackUzbekName;
exports.generateFallbackDescriptionRu = generateFallbackDescriptionRu;
exports.generateFallbackDescriptionUz = generateFallbackDescriptionUz;
exports.detectUnitFromName = detectUnitFromName;
exports.getOptimalThreadCount = getOptimalThreadCount;
exports.cleanAndParseAIResponse = cleanAndParseAIResponse;
...
function estimateTokenCount(text) {
    return Math.ceil(text.length / constants_1.DEFAULT_CONFIG.TOKEN_ESTIMATION_RATIO);
}
/**
 ...
 */
function generateFallbackUzbekName(russianName) {
 ...
 */
function generateFallbackDescriptionRu(productName) {
 ...
 */
function generateFallbackDescriptionUz(productName) {
    if (productName.toLowerCase().includes('порошок')) {
 ...
 */
function detectUnitFromName(productName) {
...
function getOptimalThreadCount() {
    try {
        ...
        optimalCount = Math.min(optimalCount * 2, constants_1.DEFAULT_CONFIG.MAX_THREADS);
        optimalCount = Math.max(optimalCount, constants_1.DEFAULT_CONFIG.MIN_THREADS);
