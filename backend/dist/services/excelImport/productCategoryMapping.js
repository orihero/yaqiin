...
exports.PRODUCT_CATEGORY_STRUCTURE = void 0;
exports.findCategoryByIndex = findCategoryByIndex;
exports.getMainCategories = getMainCategories;
exports.getSubcategories = getSubcategories;
exports.getBrandCategories = getBrandCategories;
exports.cleanCategoryName = cleanCategoryName;
exports.PRODUCT_CATEGORY_STRUCTURE = [
    // Main Categories
    {
 ...
 */
function findCategoryByIndex(productIndex) {
    // Find the most specific category that contains this index
    let bestMatch = null;
    let bestSpecificity = 0;
    for (const category of exports.PRODUCT_CATEGORY_STRUCTURE) {
...
function getMainCategories() {
    return exports.PRODUCT_CATEGORY_STRUCTURE.filter(cat => !cat.parentCategory);
}
/**
 * Get subcategories for a specific main category
 */
function getSubcategories(mainCategoryName) {
    return exports.PRODUCT_CATEGORY_STRUCTURE.filter(cat => cat.parentCategory === mainCategoryName);
}
/**
 * Get brand categories for a specific subcategory
 */
function getBrandCategories(subcategoryName) {
    return exports.PRODUCT_CATEGORY_STRUCTURE.filter(cat => cat.parentCategory === subcategoryName);
}
/**
