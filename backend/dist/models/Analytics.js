...
const AnalyticsTopProductSchema = new mongoose_1.Schema({
    productId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Product', required: true },
    name: { type: String, required: true },
    orderCount: { type: Number, required: true },
    revenue: { type: Number, required: true },
}, { _id: false });
const AnalyticsTopShopSchema = new mongoose_1.Schema({
    shopId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Shop', required: true },
    name: { type: String, required: true },
    orderCount: { type: Number, required: true },
    revenue: { type: Number, required: true },
}, { _id: false });
const AnalyticsCourierPerformanceSchema = new mongoose_1.Schema({
...
const AnalyticsMetricsSchema = new mongoose_1.Schema({
