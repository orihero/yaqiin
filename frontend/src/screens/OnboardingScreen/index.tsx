...
const OnboardingScreen: React.FC = () => {
  ...
  return (
    <div
      className="w-full flex flex-col items-center justify-center bg-[#e5e7eb] px-0 sm:px-2 overflow-hidden overflow-x-hidden"
    ...
    >
      <div className="flex flex-col w-full h-full flex-1 max-w-md mx-auto relative">
        ...
        <div className="flex flex-col flex-1 h-full">
          ...
          <div
            ref={scrollRef}
            className="w-full flex-1 flex overflow-x-auto scroll-smooth snap-x snap-mandatory bg-white relative"
            style={{ borderBottomLeftRadius: 40, borderBottomRightRadius: 40, minHeight: 224 }}
            ...
            {steps.map((s, idx) => (
              ...
              >
                <img
                  src={s.image}
                  alt={t(s.titleKey)}
                  className="w-44 h-44 object-contain md:w-64 md:h-64"
                  style={{ marginTop: 16 }}
                />
              </div>
            ))}
          ...
          <div className="w-full bg-[#232c43] rounded-t-3xl pt-8 pb-8 px-6 flex flex-col items-center z-0" style={{ minHeight: 260, overflow: 'hidden', position: 'relative', flexShrink: 0 }}>
            {/* Dots */}
            ...
            <h2 className="text-2xl font-bold text-white mb-3 text-center">{t(steps[step].titleKey)}</h2>
            <p className="text-gray-300 text-center mb-8 text-base">{t(steps[step].descKey)}</p>
