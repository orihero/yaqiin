  ...
  return (
    <div className="p-8 min-h-screen bg-[#1a2236] text-white">
      ...
      <div className="mb-4 flex items-center">
        ...
        />
        <span className="ml-4 text-gray-400">Dashboard 2 <span className="bg-blue-900 text-blue-300 px-2 py-1 rounded text-xs ml-2">Categories</span></span>
      </div>
            ...
            {isLoading ? (
              ...
              data.data.map((category, idx) => (
                <tr key={category._id} className="border-b border-[#2e3650] hover:bg-[#202840] transition">
                  ...
                  <td className="py-3 px-4 capitalize">{category.isActive ? 'Active' : 'Inactive'}</td>
                  <td className="py-3 px-4 flex gap-3">
                    <button onClick={() => { setEditCategory(category); setShowModal(true); }} className="hover:text-blue-400" title="Edit">
                    ...
                    <button onClick={() => setDeleteCategory(category)} className="hover:text-red-400" title="Delete">
